...
# 这里是在textencoder里面的对于已经，embedding后的音素编码，加上spk的编码
# # TextEncoder里面的Encoder，这里是对音速进行进一步的编码提取，使用了attention机制
...
class TextEncoder(nn.Module):
    ...
    def forward(self, x, x_lengths, emos,spks=None):
        """Run forward pass to the transformer based encoder and duration predictor
        ...
        # print("textencoderd的prenet的x", x.shape)
