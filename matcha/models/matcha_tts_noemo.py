...
from matcha.models.components.flow_matching_dit import CFM
...
class MatchaTTS(BaseLightningClass):  # 🍵
    ...
    def synthesise(self, x, x_lengths,n_timesteps, temperature=1.0, spks=None, length_scale=1.0):
        ...
        t = dt.datetime.now()
        #################这里改错了####################
        # spks = torch.tensor([20], dtype=torch.long, device=self.device)
        ...
        # 不是改这里？？？？
        # mu_y= mu_y + torch.randn_like(mu_y, device=mu_y.device) / temperature
