...
class MatchaTTS(BaseLightningClass):  # 🍵
    ...
    def synthesise(self, x, x_lengths,emos,n_timesteps, temperature=1.0, spks=None, length_scale=1.0):
        """
        ...
        mu_x, logw, x_mask = self.encoder(x, x_lengths, emos,spks)
    ...
    def forward(self, x, x_lengths,emos, y, y_lengths, spks=None, out_size=None, cond=None, durations=None):
